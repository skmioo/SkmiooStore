...
namespace Skmioo.Net
{
	...
	/// </summary>
	public class MyUnityLoadHandler : DownloadHandlerScript
	{
		/// <summary>
		...
		public MyUnityLoadHandler(OnHttpContentLength httpContentLengthHandler, OnHttpContent httpContentHandler)
		{
		...
		public MyUnityLoadHandler(byte[] buff, OnHttpContentLength httpContentLengthHandler, OnHttpContent httpContentHandler):base(buff)
		{
			cbHttpContentLength = httpContentLengthHandler;
			cbHttpContent = httpContentHandler;
			_HeaderArrived = false;
