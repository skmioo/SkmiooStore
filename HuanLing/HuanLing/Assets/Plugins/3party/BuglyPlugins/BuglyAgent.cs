...
public sealed class BuglyAgent
{
    ...
    /// </summary>
    /// <param name="type">Type. Default=0,MSDK=2</param>
    ...
    private static void InitBuglyAgent(string appId)
    {
        ...
        try {
            UnityAgent.Call("setSDKPackagePrefixName", _crashReporterPackage);
        } catch {
    ...
    private static readonly string _pluginVersion = "1.5.0";
