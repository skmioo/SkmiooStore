...
{
    [AddComponentMenu("YUI/Scrollbar", 32)]
    [RequireComponent(typeof(RectTransform))]
    public class YScrollbar : YSelectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        public RectTransform handleRect { get { return m_HandleRect; } set { if (YSetPropertyUtility.SetClass(ref m_HandleRect, value)) { UpdateCachedReferences(); UpdateVisuals(); } } }

        // Direction of movement.
        [SerializeField]
        private Direction m_Direction = Direction.LeftToRight;
        public Direction direction { get { return m_Direction; } set { if (YSetPropertyUtility.SetStruct(ref m_Direction, value)) UpdateVisuals(); } }

        protected YScrollbar()
        {}
        ...
        public float size { get { return m_Size; } set { if (YSetPropertyUtility.SetStruct(ref m_Size, Mathf.Clamp01(value))) UpdateVisuals(); } }
        ...
        public int numberOfSteps { get { return m_NumberOfSteps; } set { if (YSetPropertyUtility.SetStruct(ref m_NumberOfSteps, value)) { Set(m_Value); UpdateVisuals(); } } }
        ...
        public override YSelectable FindSelectableOnLeft()
        {
            if (navigation.mode == YNavigation.Mode.Automatic && axis == Axis.Horizontal)
                return null;
            return base.FindSelectableOnLeft();
        }

        public override YSelectable FindSelectableOnRight()
        {
            if (navigation.mode == YNavigation.Mode.Automatic && axis == Axis.Horizontal)
                return null;
        ...
        public override YSelectable FindSelectableOnUp()
        {
            if (navigation.mode == YNavigation.Mode.Automatic && axis == Axis.Vertical)
                return null;
            return base.FindSelectableOnUp();
        }

        public override YSelectable FindSelectableOnDown()
        {
            if (navigation.mode == YNavigation.Mode.Automatic && axis == Axis.Vertical)
                return null;
