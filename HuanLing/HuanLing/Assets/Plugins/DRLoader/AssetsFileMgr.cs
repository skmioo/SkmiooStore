...
namespace DRLoader
{
    ...
    /// 游戏资源文件管理
    /// </summary>
    public class AssetsFileMgr : SingletonAuto<AssetsFileMgr>, IDisposable
    {
        ...
        class LoadFileItem
        {
            ...
            public static LoadFileItem Create()
            {
                if (_Idles.Count > 0)
                {
        ...
        public void Update()
        {
            ...
            {//加载太久了，扩张加载线程数
                ...
                Debug.LogErrorFormat("{0}加载了{1}s，扩张线程:{2}！waite:{3} periot:{4}",
                    _Loadings[_Loadings.Count - 1].fileName, maxLoadTime, _MaxLoadThread, curPriority.Count, _CurPriority);
            }
