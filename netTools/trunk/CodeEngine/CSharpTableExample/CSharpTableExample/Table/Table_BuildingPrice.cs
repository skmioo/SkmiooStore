...
[Serializable]
 public class Tab_BuildingPrice : ITableOperate
{ private const string TAB_FILE_DATA = "./GameData/building_price.plist";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_NAME,
...
public IEnumerator LoadTable(Hashtable _tab)
 ...
 Tab_BuildingPrice _values = new Tab_BuildingPrice();
