...
[Serializable]
 public class Tab_BuildingFunction : ITableOperate
{ private const string TAB_FILE_DATA = "./GameData/building_function.plist";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_NAME,
...
public IEnumerator LoadTable(Hashtable _tab)
 ...
 Tab_BuildingFunction _values = new Tab_BuildingFunction();
